...
TEST_F(TestNetworkCommissioningLogic, TestAttributes)
{
    BindingServerCluster cluster(1);
    ReadOnlyBufferBuilder<AttributeEntry> builder;
    ASSERT_EQ(cluster.Attributes({ kRootEndpointId, Binding::Id }, builder), CHIP_NO_ERROR);
