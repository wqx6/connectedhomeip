...
public:
    ...
    long PrepareEvents(int & aMaxFd, fd_set & aReadSet, fd_set & aWriteSet, fd_set & aErrorSet);
    void ProcessEvents(const fd_set & aReadSet, const fd_set & aWriteSet, const fd_set & aErrorSet);
